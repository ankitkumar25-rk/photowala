...
const SIZE_OPTIONS     = ['A4', 'A3', 'A5', 'Letter', 'Custom'];
  ...
  return (
    <div className="min-h-screen bg-[#faf8f5] flex flex-col md:flex-row font-sans">
      ...
      <main className="flex-1 p-6 md:p-10 lg:p-12">
        ...
        <div className="mb-10">
          <h1 className="text-4xl font-extrabold text-gray-900 mb-3 tracking-tight">Digital Paper Printing</h1>
          <p className="text-gray-600 max-w-3xl leading-relaxed">Premium media options for professional-grade digital prints.</p>
        </div>

        <div className="flex flex-col lg:flex-row gap-8 items-start">
          <div className="w-full lg:w-2/3 flex flex-col gap-6">
            <div className="bg-white rounded-2xl border border-[#e8dfd5] p-6 lg:p-8 shadow-sm">
              <div className="flex items-center gap-3 mb-6"><Layers className="w-5 h-5 text-[#a64d24]" /><h3 className="text-lg font-bold text-gray-900">Select Product</h3></div>
              ...
              <div className="border-t border-gray-100 pt-8 grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div><label className="block text-sm font-semibold text-gray-700 mb-2">Order Name</label>
                  <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="e.g. Brochure Batch April"
                ...
                <div className="md:col-span-2"><label className="block text-sm font-semibold text-gray-700 mb-2">Paper Size</label>
                  <select value={size} onChange={(e) => setSize(e.target.value)} className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[#b65e2e]/50 focus:border-[#b65e2e]">
            ...
            <div className="bg-[#1c1a19] text-white rounded-2xl overflow-hidden shadow-lg border border-gray-800">
              <div className="p-6">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex justify-between text-sm"><span className="text-gray-400">Paper Size</span><span className="font-medium">{size||'-'}</span></div>
                ...
                <p className="text-center text-xs text-gray-500 italic">{sel&&qty?'Est. delivery: 1 business day':'Select product & quantity to proceed'}</p>
              </div>
            </div>
          </div>
        </div>
