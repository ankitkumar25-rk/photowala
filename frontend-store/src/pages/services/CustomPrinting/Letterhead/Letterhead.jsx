...
import {
  ...
  HelpCircle, UploadCloud, AlertTriangle, ShoppingCart, Package, File as LucideFile, Loader2, Truck
} from 'lucide-react';
import api from '../../../../api/client';

const SIDEBAR_LINKS = [
  { id: 'pen',        icon: PenTool,    label: 'Pen',                    to: '/services/custom-printing/pen' },
  { id: 'sticker',    icon: LucideFile, label: 'Sticker Labels',         to: '/services/custom-printing/sticker-labels' },
